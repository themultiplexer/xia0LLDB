...
def __lldb_init_module(debugger, internal_dict):
    ...
    # print('========')
    # print('[xsbt]: Resymbolicate stripped ObjC backtrace')
    # print('\txbr [-f BlockSymbolFile]')
    # print('\tmore usage, try "xsbt -h"')
...
def handle_command(debugger, command, exe_ctx, result, internal_dict):
    ...
    if options.file:
        ...
        if BLOCK_JSON_FILE:
            ...
            result.AppendMessage('  BlockSymbolFile    {}'.format(colorme.attr_str('Not Set The Block Symbol Json File, Try \'xsbt -f\'', 'redd')))
            pass
